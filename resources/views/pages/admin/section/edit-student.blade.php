            ...
            <div class="col-lg-12 col-12">
                <div class="box">
                  <div class="box-header with-border">
                    <h4 class="box-title">Student Credentials</h4>
                  </div>
                  <!-- /.box-header -->
                  <form method="POST" action="{{url('administrator/section/update-student/'.$student->id)}}">
                      @csrf
                      <input type="hidden" name="section_id" value="{{$studentSection->section_id}}">
                    <input type="hidden" id="role_id" class="role_id form-control" type="text" name="role_id" value="student"/>
                      ...
                      <div class="box-footer text-right">
                          <a href="{{url('administrator/section/details/'.$studentSection->section_id)}}" class="btn btn-rounded btn-danger btn-outline mr-1">
